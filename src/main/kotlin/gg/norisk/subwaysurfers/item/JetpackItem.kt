...
import gg.norisk.subwaysurfers.client.renderer.armor.JetpackItemRenderer
...
class JetpackItem(settings: Settings) : ArmorItem(
    ...
    override fun createRenderer(consumer: Consumer<Any>) {
        consumer.accept(object : RenderProvider {
            ...
            override fun getHumanoidArmorModel(
                ...
                if (this.renderer == null) this.renderer = JetpackItemRenderer()
